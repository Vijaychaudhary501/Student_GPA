...
class SG_MypostVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let grpStudyNib = UINib(nibName: Constant.GRPSTUDYVIEW_NIBNAME, bundle: nil)
        self.grptableView.register(grpStudyNib, forCellReuseIdentifier: Constant.GRPSTUDYVIEWID)
    ...
    func report_editBtnTaped (sender:UIButton) {
 ...
 */
    ...
    func askToJoinClicked(sender:UIButton){
        print(sender.tag)
