...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        // vijay let _ = YoutubeExampleViewController(nibName: nil, bundle: nil)
        //sleep(3)
        //let kClientId = "7edfd4af1833461a8f2daf2c0dba89ce"
        //let kClientSecret = "3960d715-6610-410f-88d7-4499420e47a5"
        //AdobeUXAuthManager.shared().setAuthenticationParametersWithClientID(kClientId, withClientSecret: kClientSecret)
        // Override point for customization after application launch.
        // vijayIQKeyboardManager.sharedManager().enable = true
        // vijay Fabric.with([Crashlytics.self])
        self.logUser()
        //User Device ID
        let deviceID = UIDevice.current.identifierForVendor!.uuidString
        //print(deviceID)
       // vijay UserDefaults.standard.setValue(deviceID, forKey: Constant.DEVICE_TOKEN )
       ...
       // vijay UINavigationBar.appearance().titleTextAttributes = [NSForegroundColorAttributeName : UIColor.white]
        
        //self.createMenubar()
        // User Push notification register
    ...
    func logUser() {
      ...
      /*  Crashlytics.sharedInstance().setUserEmail(Constant.USER_DEFAULT.value(forKey:"email") as? String ?? "Tester")
        
        Crashlytics.sharedInstance().setUserIdentifier("Student")
